            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  ...
                  <p className="text-medium-brown font-light text-lg mb-1">
                    {exp.role}
                  </p>
                ...
                <a
                  ...
                  className="text-medium-brown hover:text-medium-brown/80 transition-colors flex-shrink-0 ml-2"
              ...
              <div className="space-y-2 pt-4 border-t border-cream-beige/10">
                {exp.description.map((desc, idx) => (
                  <div key={idx} className="flex items-start gap-2 text-light-text text-sm">
