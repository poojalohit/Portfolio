            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex-1">
                  <h3 className="text-2xl font-serif font-bold mb-1 text-white">{exp.company}</h3>
                  <p className="text-lime font-semibold text-lg mb-1">
                    {exp.role}
                  </p>
                ...
                <a
                  ...
                  className="text-cyan hover:text-cyan-dark transition-colors flex-shrink-0 ml-2"
